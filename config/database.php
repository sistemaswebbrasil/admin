...
return [
    ...
    'connections' => [
        ...
        'mysql'             => [
            ...
            'username'    => env('DB_USERNAME', 'adriano'),
        ...
        'mysql-macae'       => [
            ...
            'database'    => env('DB_DATABASE_MACAE', 'admin'),
            'username'    => env('DB_USERNAME_MACAE', 'adriano'),
            'password'    => env('DB_PASSWORD_MACAE', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset'     => 'utf8mb4',
            'collation'   => 'utf8mb4_unicode_ci',
            'prefix'      => '',
        ...
        'mysql-homologacao' => [
            ...
            'database'    => env('DB_DATABASE_HOMOLOGACAO', 'admin'),
