        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    {{ $permission->created_at->formatLocalized('%d %B %Y') }}
                    @endif
                </td>
                <td>
                ...
                <td>
                    <a class="btn btn-info" data-target="#modal-default" data-toggle="modal" href="#" title="{{ trans('geral.mostrardetalhes') }}" data-id="{{ $permission->id }}" >
                        <i class="fa fa-eye">
                        </i>
                    </a>
                    <a "="" class="btn btn-primary" href="{{ route('permission.edit',$permission->id) }}" title="{{ trans('geral.editar') }}">
                        <i class="fa fa-edit">
                        </i>
                    </a>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    {{ trans('geral.mostrardetalhes',[ 'name' => $permission->name ]) }}
                </h4>
            </div>
            <div class="modal-body">
                <!-- @include('permission.show',['permission','$permission->id']) -->
